...
<html>
	...
	<script type="text/javascript">
		...
		//비동기 통신의 다른 방법 axios 라이브러리 : 우리 서버에 table 정보를 insert 하기 위한 통신
		//함수 requestPaymentSave 는 async (비동기) 처리한다는 의미입니다.
		async function requestPaymentSave(payReq){
			//await 은 axios가 post 요청을 보낸 후 응답을 기다린다는 의미입니다.
		...
		//토스가 보내준 응답 payment 값을 api/pay 로 보내고 db에 insert 할 것입니다.
		...
		.catch(e=> {			//요청에 오류 생겼을때 실행(axios 메소드).
